...
shell('sqlplus -s UP_ALESSANDRO_PIOVANI/Statistica2023.@EXAPES @estrai.sql')
...
cat("Ci sono", sum(modellitrim$PROGRESSIVO==10), "serie trimestrali da destagionalizzare in questo gruppo di serie","\n\n\n")
