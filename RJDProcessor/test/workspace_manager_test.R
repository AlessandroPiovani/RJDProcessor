...
ws_merged <- merge_workspaces(source_workspaces_path=single_workspaces_path, merged_ws_name = "merged_ws", compressed = TRUE, delete_originals = TRUE, silent=TRUE)
ws_merged <- merge_workspaces(source_workspaces_path=single_workspaces_path, merged_ws_name = "merged_ws2", merged_ws_dir = "C:\\Users\\UTENTE\\Desktop\\RJDopenCruncher\\test\\merged_ws2" ,compressed = TRUE, delete_originals = TRUE, silent=TRUE)
