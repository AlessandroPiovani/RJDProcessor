...
JD_JSON_from_materialized_workspace(input_workspace, ext_reg_input_data_reader_xlsx, JSON_file_name = "specifications_new_xlsx.txt", diff=TRUE, java_processing=FALSE)
JD_JSON_from_materialized_workspace(input_workspace, ext_reg_input_data_reader_csv,  JSON_file_name = "specifications_new_csv.txt",  diff=TRUE, java_processing=FALSE)
...
compare_sa_ts(new_model_workspace = virtual_workspace_csv, old_model_workspace = input_workspace , materialized_ws_new=FALSE, materialized_ws_old=TRUE, java_processing_old_model=FALSE)
