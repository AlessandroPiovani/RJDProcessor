...
setwd("U:\\Desktop\\SITIC-NOT-aggregazione\\")
...
if(nrow(identificativi)!=0) {
   ...
   if(Sys.info()["sysname"]!='Linux'){
      ...
      system("U:\\TRAMO\\Tramo.exe  -i serietsplusm.txt -o outtsplusm -g outgtsplusm",ignore.stdout = TRUE,ignore.stderr = TRUE) 
      system("U:\\SEATS\\Seats.exe -i seats.itr  -o outtsplusm -g outgtsplusm",ignore.stdout = TRUE,ignore.stderr = TRUE)
   } else {
...
if(nrow(identificativi)!=0) { 
   ...
   if(Sys.info()["sysname"]!='Linux'){
      # esegui ts - comandi DOS
      system("U:\\Tramo\\Tramo.exe  -i serietsplust.txt -o outtsplust -g outgtsplust",ignore.stdout = TRUE,ignore.stderr = TRUE) 
      system("U:\\Seats\\Seats.exe -i seats.itr  -o outtsplust -g outgtsplust",ignore.stdout = TRUE,ignore.stderr = TRUE)
   } else {
      # esegui ts - comandi linux
